...
#if 0 // Swithed to calculated table to save initialized data space.
/* ====================================================================== */
/*  																      */
...
uint32_t __crc32(uint32_t crc32val, uint8_t *s, uint32_t len, uint32_t *tbl);

uint32_t crc32(uint32_t crc32val, uint8_t *s, uint32_t len)
{
	return __crc32(crc32val, s, len, crc32_tab);
}
